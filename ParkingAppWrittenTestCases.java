...
public class ParkingAppWrittenTestCases
{
  ...
  public void RegisterStudent()
  {
    //acount neeeds validation
	  ...
	  User student2 = factory.createUser("email10@email.com", "Password10!", "student");
	  User student3 = factory.createUser("email11@email.com", "Password11!", "student");
  ...
  public void InvalidLicensePlate()
  {
	...
	//Create start and end time
	  ...
	  assertFalse(faculty.bookSpace(start, end, 0, 90, "invalid"));
  }
  ...
  {
	//Sign in with random faculty account
	  Client student = (Client) System1.signIn("email10@email.com", "Password10!");
	//Create start and end time
	  Calendar calStart = Calendar.getInstance();
	  calStart.set(Calendar.YEAR, 2023);
	  calStart.set(Calendar.MONTH, 7);
  ...
  public void DisableLot1()
  {
	...
	//Sign in with random manager account
	  Manager manager = (Manager) System1.signIn("email3@email.com", "Password3!");
